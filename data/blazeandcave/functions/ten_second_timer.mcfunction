...
# Australia
execute if score time bac_current_time matches 13000..13200 if score australia bacap3_sushi matches 1 run function blazeandcave:bacap3/australia
...
# Updates score so advancement revokes don't mess it up
