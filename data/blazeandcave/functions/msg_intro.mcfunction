...
tellraw @s {"color":"#D1FFFD","bold":false,"translate":"Thank you for downloading","extra":[{"text":"\n"},{"color":"yellow","bold":true,"translate":"Blaze"},{"color":"gray","bold":true,"translate":"and"},{"color":"aqua","bold":true,"translate":"Cave"},{"color":"gray","bold":true,"translate":"'s Advancements Pack 3!"}]}
tellraw @s {"text":" "}
